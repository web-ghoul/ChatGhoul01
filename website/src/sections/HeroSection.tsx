    ...
    return (
        <Container class="grid justify-stretch items-center !py-8 hero_section">
            <div class="bg-hero bg-cover bg-center bg-no-repeat rounded-3xl w-full h-full relative overflow-hidden">
                ...
                <div class={`grid justify-stretch items-center gap-6 w-1/2 relative z-[1] !px-10 top-[50%] translate-y-[-50%]`}>
                    <div class={`grid justify-stretch items-center gap-4`}>
                        <h1 class="text-7xl !font-[700] !text-white">Message privately</h1>
